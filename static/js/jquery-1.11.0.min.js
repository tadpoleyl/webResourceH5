...
!function ($) {
    ...
    Slider.prototype.slipping = function (_this) {
        ...
        var maxHeight =self.slider.offset() && self.slider.offset().height;//获取可移动元素的最大高度。
        var parentHeight =self.slider.parent().offset() && self.slider.parent().offset().height;//获取可视区的最大高度
